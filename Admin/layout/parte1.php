...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #000080;">
        <!-- Brand Logo -->
        <a href="<?php echo $url;?>/public/templates/AdminLTE-3.2.0/index3.html" class="brand-link">
            <img src="<?php echo $url;?>/imagenes/cuidado-de-mascotas.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">Admin AnimalCare</span>
        </a>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?php echo $url;?>/Admin/usuarios/index1.php" class="nav-link">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?php echo $url;?>/Admin/reservas/reservas.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="<?php echo $url;?>/app/contoladores/login/cerrar_sesion.php" class="nav-link active" style="background-color: red">
