<?php $url = "http://localhost/veterinaria"; 
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-sm-12">
                <div class="logo">
                    <a href="<?php echo BASE_URL; ?>" class="logo-link">
                        <img src="<?php echo $url; ?>/imagenes/cuidado-de-mascotas.png" width="30">
                        <p style="font-size: 24px; margin: 5px; color: white; font-family: Arial, sans-serif;">Tienda AnimalCare</p>
                    </a>
                </div>
            </div>
        </div>
